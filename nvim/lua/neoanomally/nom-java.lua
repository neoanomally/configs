...
--
--         -- Detect Roots
--         local bazel_root = vim.fs.root(0, { "BUILD.bazel", "BUILD" }) -- "MODULE.bazel", "WORKSPACE
--         local standard_root = vim.fs.root(0, { 'gradlew', '.git', 'mvnw' })
...
--             cmd = { vim.fn.stdpath("data") .. "/mason/bin/java-language-server" },
--             root_dir = bazel_root,
--             root_marker = { "BAZEL.build", "WORKSPACE", "WORKSPACE.bazel" },
--             cmd_cwd = bazel_root,
--             capabilities = capabilities,
--             cmd_env = {
--               JAVA_HOME = sdk_java_path,
...
--          }
--
--           vim.lsp.start(jls_config, jls_opts)
--       else
--         -- CASE B: Standard JDTLS Setup
--         local config = {
